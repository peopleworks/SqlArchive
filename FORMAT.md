...
| `money`, `smallmoney` | JSON **string**, four decimals | Read through `SqlMoney.Value`, never `SqlMoney.ToString()`, which formats with **two** decimals and would silently archive `922337203685477.5807` as `922337203685477.58`. |
